...
class BianconiglioInterface:
    ...
    def load_config(self):
        ...
        if os.path.exists(self.config_file_path) and os.path.exists(self.config_file):
            with open(self.config_file, "r") as f:
                ...
                self._logger.info("Bianconiglio configuration loaded. URL: %s", self.config.xgb_url)
    ...
    def get_xgb_models_info(self):
        ...
        url = f"{self.config.xgb_url}/models"
    ...
    def get_xgb_model_state(self, model_id: str) -> str | None:
        ...
        url = f"{self.config.xgb_url}/models/{model_id}/status"
    ...
    def get_log(self, model_id: str):
        ...
        url = f"{self.config.xgb_url}/models/{model_id}/logs"
    ...
    def train(self, description: str, data: pd.DataFrame, features: list[str], targets: list[str], url: str | None = None) -> dict:
        ...
        url = url or f"{self.config.xgb_url}/models/train"
    ...
    def retrain(self, model_id: str, new_description: str, data: pd.DataFrame, features: list[str], targets: list[str]):
        ...
        url = f"{self.config.xgb_url}/models{model_id}/retrain"
    ...
    def predict(self, model_id: str, data: pd.DataFrame) -> dict:
        ...
        url = f"{self.config.xgb_url}/models/{model_id}/predict"
    ...
    def get_dataframe(self, file_path: str) -> pd.DataFrame | None:
        ...
        """API get thath retrieve the context id/token generated by chord when i start
          a new connection between shape and chord. 
          Id/token that is used to get infos about the context with the other methods.
          This id/token is temporary and related to the current communication
          The api response is like this: {"contect_id": ID}
          Returns:
        ...
        url = f"{self.config.chord_url}{self.config.user}/init-conext" 
