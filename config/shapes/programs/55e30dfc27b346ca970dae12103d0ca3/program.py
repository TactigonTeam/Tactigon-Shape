...
def tactigon_shape_function(
    ...
    touch = tskin.touch
    if chords_ml_get_model_state(chords_ml, "9bf974a3-4f2c-4a3d-ae6a-38595cd88aa5") == ChordsMLModelStateEnum("READY_TO_PREDICT"):
        debug(logging_queue, chords_ml_predict(chords_ml, '9bf974a3-4f2c-4a3d-ae6a-38595cd88aa5', chords_ml_load_dataframe(chords_ml, "/home/dev01/projects/tactigon/Tactigon-Shape/Dataframes", "/home/dev01/projects/tactigon/Tactigon-Shape/Dataframes/predict_data.json")))
        predict_flag = False
        return False
